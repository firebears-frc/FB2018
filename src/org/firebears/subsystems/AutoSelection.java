...
public class AutoSelection extends Subsystem {
	...
	CommandGroup leftSideLeftScale = null; // leftSideLeftScaleCommand
	CommandGroup leftSideRightScale = null; // leftSideRightScaleCommand
	CommandGroup leftSideLeftSwitch = null; // leftSideLeftSwitchCommand
	CommandGroup leftSideRightSwitch = null; // leftSideRightSwitchCommand
	CommandGroup rightSideLeftScale = null; // rightSideLeftScaleCommand
	CommandGroup rightSideRightScale = null; // rightSideRightScaleCommand
	CommandGroup rightSideLeftSwitch = null; // rightSideLeftSwitchCommand
	CommandGroup rightSideRightSwitch = null; // rightSideRightSwitchCommand
	CommandGroup middleSideLeftSwitch = null; // middleSideLeftSwitchCommand
	CommandGroup middleSideRightSwitch = null; // middleSideRightSwitchCommand
	CommandGroup bothSideCrossAuto = null; //bothSideCrossAutoCommand
	
	

	public CommandGroup getAuto() {
		
		CommandGroup selectedAuto = null;
