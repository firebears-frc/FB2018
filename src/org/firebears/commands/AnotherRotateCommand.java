 ...
 */
public class AnotherRotateCommand extends PIDCommand {
    ...
    public AnotherRotateCommand(double degrees) {
	...
	return Math.abs(RobotMap.chassisLeftMaster.getSelectedSensorVelocity(RobotMap.PID_IDX)) < 1 && Math.abs(getAngleDifference(RobotMap.navXBoard.getAngle(), targetAngle)) < 1.5;
    }
